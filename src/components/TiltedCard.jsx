    ...
    >
      ...
      >
        ...
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 [transform:translateZ(0)] rounded-[15px] object-cover shadow-lg will-change-transform"
          style={{
            width: imageWidth,
            height: imageHeight,
          }}
        ...
        {displayOverlayContent && overlayContent && (
          <motion.div className="absolute top-0 left-0 z-[2] h-full w-full [transform:translateZ(30px)] will-change-transform">
            {overlayContent}
          </motion.div>
        )}
      </motion.div>
